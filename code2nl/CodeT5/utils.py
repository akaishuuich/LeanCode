...
def load_and_cache_gen_data(args, filename, pool, tokenizer, split_tag,weight_dicts, only_src=False, is_sample=False):
    ...
    if os.path.exists(cache_fn) and not is_sample and not args.gen_weight:
        ...
        tuple_examples = [(example, idx, tokenizer, args, split_tag,weight_dicts) for idx, example in enumerate(examples)]
