...
from evaluator.CodeBLEU.bleu import modified_precision
...
def sentence_bleu(
    ...
    utils (this is called BLEU-4). To evaluate your translations with
    higher/lower order ngrams, use customized utils. E.g. when accounting
    for up to 5-grams with uniform utils (this is called BLEU-5) use:
    >>> utils = (1./5., 1./5., 1./5., 1./5., 1./5.)
    >>> sentence_bleu([reference1, reference2, reference3], hypothesis1, utils) # doctest: +ELLIPSIS
    0.3920...
    :param references: reference sentences
    :type references: list(list(str))
    :param hypothesis: a hypothesis sentence
    :type hypothesis: list(str)
    :param weights: utils for unigrams, bigrams, trigrams and so on
    :type weights: list(float)
    :param smoothing_function:
    :type smoothing_function: SmoothingFunction
    :param auto_reweigh: Option to re-normalize the utils uniformly.
...
def corpus_bleu(
    ...
    # order of n-grams < 4 and utils is set at default.
    if auto_reweigh:
